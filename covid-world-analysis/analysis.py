...
# sorting the data by deaths
consolidated_data_sorted = consolidated_data.sort_values(by=['New_deaths'], ascending=False)
filtered_most_deaths = consolidated_data_sorted.head(10)

# bar chart most deaths
plt.figure(figsize=(10, 6))
plt.bar(filtered_most_deaths['country'], filtered_most_deaths['New_deaths'], label='Covid-19 deaths by country', color='red')
